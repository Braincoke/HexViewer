...
import com.erwandano.hexviewer.utils.ByteDiff;
...
public class HexDiffWebView extends StackPane {
    ...
    /**
     * Load the lines held in the HexDiffs
     * @param diff          The HexDiff containing the differential of the two hex dumps
     * @param isReference   Indicate if we are loading the line of the reference file
     */
            ...
            if (newState == Worker.State.SUCCEEDED) {
                webEngine.setUserStyleSheetLocation(
                        getClass().getClassLoader().getResource(
                                "com/erwandano/hexviewer/resources/css/hexdiffwebview/"+ theme.getFilename()
                        ).toExternalForm()
                );
            }
        });
